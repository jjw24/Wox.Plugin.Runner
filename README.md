...
This is a port of the Wox plugin [Runner](https://github.com/jessebarocio/Wox.Plugin.Runner) created by Jesse Barocio @jessebarocio, and based on the [fork](https://github.com/CrazyCoder/Wox.Plugin.Runner) from Serge Baranov @CrazyCoder.
